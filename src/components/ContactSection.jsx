...
const contacts = [
  {
    label: 'Email',
    value: 'contact.ru2ya@gmail.com',
    href: 'mailto:contact.ru2ya@gmail.com',
    icon: (
  ...
  {
    label: 'Phone',
    value: '+213 793 08 05 67',
    href: 'tel:+213793080567',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <section ref={sectionRef} id="contact" className="contact-section" data-cursor="default">
      <div className="container">
        <div ref={headerRef} className="contact-header">
          <h2 className="contact-title">Contactez ru2ya — Studio Créatif</h2>
          <p className="contact-desc">
            Un projet en tête ? Parlons-en. Développement web, design graphique, production vidéo ou design t-shirt — nous sommes à votre écoute.
          </p>
        </div>
